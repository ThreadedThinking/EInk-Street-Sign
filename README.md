...
#Hardware
An electrophoretic display was chosen as it can hold an image without a power and it requires very little energy to update. The screen is based on an LB060S01-RD02. It basically needs a board with a connector to adapt to the ribbon.  It is powered right from the econotag.
